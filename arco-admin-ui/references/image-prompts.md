...
```
工作台，顶栏 #004EA2，左白菜单，内容含快捷操作图标卡、
我的任务列表、待办 Tab 与处理按钮、常用系统宫格、通知公告、
右侧用户卡与日程日历，ui组业务组件风格...
```
...
内容标题「计划信息」右上返回，下方横向四步流程条当前步蓝其余灰，
...
标题+返回后直接基本信息等 Descriptions 分块与表格，ui组业务组件风格...
```
